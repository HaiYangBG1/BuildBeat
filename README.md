...
> 一个 Builder + N 个并行 AI 会话,像一支小团队一样交付中大型项目。
...
*版本:v1(2026-06-10 首次蒸馏)· v1.1(2026-07-02 回灌三周实战:生产漂移检测机制 + 教训 11–13) · v1.2(2026-07-04 回灌:教训 14 UI 元注释复发 + §1.5 零元注释红线 + reviewer 清单第 6 条)。后续项目再踩出新坑,记得回填 lessons.md——这份技能本身也适用"证据制+单点事实":教训只在 lessons.md 登记一处。*
