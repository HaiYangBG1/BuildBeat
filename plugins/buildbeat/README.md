...
This directory is the self-contained marketplace boundary for the `buildbeat` plugin. Its `SKILL.md`, templates, reference docs, lessons, changelog, and license are repository-relative symbolic links to the canonical files at the marketplace root.
